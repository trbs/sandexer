...
class Icons():
    def __init__(self, cfg):
        ...
        self.additional_icons_exts = {
            ...
            '.dbr': 16, '.mdx': 16, '.x64': 16, '.mdf': 16, '.xmf': 16, '.k3b': 16,
            ...
            '.cif': 16, '.ashdisc': 16, '.dmg': 16, '.bws': 16, '.st': 16, '.bwt': 16,
            '.p2g': 16, '.volarchive': 16, '.lnx': 16, '.ima': 16, '.2mg': 16, '.vhdx': 16,
            '.img': 16, '.imz': 16, '.sdsk': 16, '.qcow': 16, '.xdi': 16, '.tzx': 16,
            '.i02': 16, '.i01': 16, '.i00': 16, '.fdd': 16, '.dsk': 16, '.eui': 16,
            '.edv': 16, '.b5i': 16, '.eds': 16, '.adf': 16, '.edq': 16, '.adz': 16,
            '.edk': 16, '.b5t': 16, '.ede': 16, '.flg': 16, '.uibak': 16, '.eda': 16,
            '.tib': 16, '.t64': 16, '.udf': 16, '.pxi': 16, '.ndif': 16, '.sco': 16,
            '.l01': 16, '.vmwarevm': 16, '.vc4': 16, '.vc6': 16, '.vc8': 16, '.partimg': 16,
            '.nn': 16, '.winclone': 16, '.image': 16, '.rdf': 16, '.bif': 16, '.fcd': 16,
            '.dcf': 16, '.vdi': 16, '.tap': 16, '.aa': 16, '.vcd': 16, '.xmd': 16,
            '.mlc': 16, '.vco': 16, '.mbi': 16, '.wil': 16, '.wim': 16, '.simg': 16,
            ...
            '.gdrive': 16, '.pgd': 16, '.dax': 16, '.smi': 16, '.qcow2': 16, '.e01': 16,
            '.ratdvd': 16, '.b6i': 16, '.cue': 16, '.ncd': 16, '.vhd': 16, '.lcd': 16,
            '.vfd': 16, '.p2i': 16, '.b6t': 16, '.cfs': 16, '.dxp': 16, '.vmdk': 16,
            '.omg': 16, '.atr': 16, '.g41': 16, '.gi': 16, '.000': 16, '.sparseimage': 16,
            '.pqi': 16, '.nri': 16, '.nrg': 16, '.tao': 16, '.mrimg': 16, 'iso': 17,
            'dmg': 17
